...
public class GuiGameController {
    ...
    protected void showMessage(UpdateTurnMessage currentMove, String messageToShow) {
        ...
        Platform.runLater(() -> {
            txtNickname.setText(guiController.getPlayerOwnerNickname());
            txtGod.setText("GOD IN ACTION:\n" + currentMove.getCurrentPlayer().getPlayerCard().toString());
    ...
    /**
     * Convert the event generated by a button in the associated command.
     *
     * @param event Event generated by a command button.
     */
    @FXML
    ...
    /**
     * Convert the event generated by a button in a pair of coordinates.
     *
     * @param event Event generated by a clickable button.
     */
    @FXML
...
//            System.out.println("Cella cliccata: " + coordinate);
    ...
    /**
     * Convert a position described by two integers in a string that represent the coordinates.
     *
     * @param colIndex Index of the grid column of the clicked button.
     * @param rowIndex Index of the grid row of the clicked button.
     * @return Returns a string that represent the coordinates of the clicked button.
     */
    ...
    /**
     * Verify if a specific slot need to be refreshed or not.
     *
     * @param slot The slot check.
     * @return Returns a boolean that inform if the slot needs to be refreshed or not.
     */
